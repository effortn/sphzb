...
create table questions (
  ...
  answer_a smallint NOT NULL COMMENT '选项A',
  answer_b smallint NOT NULL COMMENT '选项B',
  answer_c SMALLINT NOT NULL COMMENT '选项C',
  answer_d SMALLINT NOT NULL COMMENT '选项D',
